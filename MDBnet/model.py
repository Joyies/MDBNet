...
class BasicSepConv(nn.Module):
    def __init__(self, in_planes, kernel_size, stride=1, padding=0, dilation=1, groups=1, relu=True, bn=False, bias=False):
...
class MDBNet(nn.Module):
    def __init__(self, load_weights=False):
        super(MDBNet, self).__init__()
        self.seen = 0
...
X_net = nn.Sequential(
    BasicRFB_a(512, 256, scale=1),
    BasicRFB_a(256, 128, scale=1),
    BasicRFB_a(128, 64, scale=1),
)